...
EW_stations = {"EW1": StationInfo(name="Pasir Ris",
...
BP_stations = {"BP1": StationInfo(name="Choa Chu Kang", travel=[TravelInfo("BP2", 2), TravelInfo("NS4", 2)]),
